        ...
        {isLoading && (
          <div className="flex items-center gap-2 text-[#a1a1a1]">
            <div className="flex space-x-1">
              <div className="w-2 h-2 bg-teal-500 rounded-full loading-dot" />
              <div className="w-2 h-2 bg-teal-500 rounded-full loading-dot" />
              <div className="w-2 h-2 bg-teal-500 rounded-full loading-dot" />
            </div>
      ...
      <div className="border-t border-[#2a2a2a] p-4 bg-[#0c0c0c]">
        <div className="flex gap-2">
          <textarea
            ...
            className="flex-1 resize-none bg-[#1e1e1e] border border-[#2a2a2a] rounded-lg px-3 py-2 text-sm text-[#f5f5f5] placeholder-[#666] focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50"
            rows={1}
            disabled={isLoading}
          />
          <button
            ...
            className="bg-teal-500 hover:bg-teal-600 disabled:bg-[#2a2a2a] disabled:text-[#666] text-gray-950 rounded-lg px-4 py-2 transition-colors"
        ...
        {message.metadata?.actions && message.metadata.actions.length > 0 && (
          <div
            className={`mt-2 pt-2 border-t ${
              isUser ? "border-teal-600/30" : "border-[#2a2a2a]"
            }`}
          >
